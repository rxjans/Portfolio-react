...
const Services = () => {
  ...
  return <div className='section pb-48' id='services' ref={ref}>
      ...
      <motion.div
        ...
        <div className='flex flex-col xl:flex-row gap-x-8 lg:gap-x-16 lg:gap-y-0 items-center'>
          ...
          className='flex h-[400px]'>
            <div className='lg:w-[560px] lg:min-w-[320px] mb-8 xl:mb-0 border-gradient border-b py-10 px-20 rounded-2xl bg-gradient-to-r from-indigo-500/50 from-10% to-fuchsia-500/50 hover:bg-site'>
          ...
          whileInView={'show'}
          viewport={{once: false, amount:0.7}}
          className='flex xl:h-[400px] '>
          <div className='lg:w-[560px] lg:min-w-[320px]  border-gradient border-b py-10 px-20 rounded-2xl bg-gradient-to-r from-indigo-500/50 from-10% to-fuchsia-500/50 hover:bg-site'>
